...
<body>
    <div id="app">
        <div style="min-height: 60px">
            <nav class="navbar navbar-expand-lg fixed-top background-color">
                <div class="container">
                    <a class="navbar-brand mb-0 h1 nav-link" href="{{ url('/') }}">Gyvūnų paieškos sistema</a>
                    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
                        <span id="logo" class="fas fa-bars"></span>
                    </button>
        ...
        <div class="mt-5">
            <footer class="footer font-small background-color mt-5">
    ...
    <script src="https://kit.fontawesome.com/8622aacd17.js" crossorigin="anonymous"></script>
</body>
</html>
